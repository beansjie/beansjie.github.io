...
```
行内式 [博客](https://beansjie.github.io/ "我的个人博客") 链接，带 title。
...
```html
<p>行内式 <a href="https://beansjie.github.io/" title="我的个人博客">博客</a> 链接，带 title。</p>

<p>行内式 <a href="https://github.com/mzlogin">GitHub</a> 链接。</p>

<p>引用式 <a href="https://beansjie.github.io/">博客</a> 链接。</p>
...
```
![Alt text](https://beansjie.github.io//favicon.ico "favicon")
```
...
```html
<img src="https://beansjie.github.io//favicon.ico" alt="Alt text" title="favicon">
```
...
另外可以参考我以前的一篇博客 [关于 Markdown 的一些奇技淫巧](https://beansjie.github.io//2017/09/01/markdown-odd-skills/)。
...
* [关于 Markdown 的一些奇技淫巧](https://beansjie.github.io//2017/09/01/markdown-odd-skills/)

---

欢迎关注我的微信公众号，接收 markdown-intro 最新动态。

<div align="center"><img width="192px" height="192px" src="https://beansjie.github.io//assets/images/qrcode.jpg"/></div>
