...
[使用本插件生成 TOC 的中文文档在线示例](https://beansjie.github.io//wiki/chinese-copywriting-guidelines/)

![](https://github.com/mzlogin/vim-markdown-toc/raw/master/screenshots/chinese.gif)

## 参考链接

* [GFM 与 Redcarpet 的不同点](https://beansjie.github.io//2015/12/05/diff-between-gfm-and-redcarpet/)
